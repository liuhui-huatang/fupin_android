 ...
 */
package com.huatang.fupin.zxing.activity;
...
import com.huatang.fupin.activity.WebActivity;
import com.huatang.fupin.utils.ToastUtil;
import com.huatang.fupin.zxing.assit.AmbientLightManager;
import com.huatang.fupin.zxing.assit.BeepManager;
import com.huatang.fupin.zxing.camera.CameraManager;
import com.huatang.fupin.zxing.view.ViewfinderView;
...
//        setResult(resultCode, new Intent().putExtra(EXTRA_SCAN_RESULT, resultStr));
        if (resultCode == RESULT_CANCELED) {
            ...
            WebActivity.startIntent(this, resultStr);
        }
        finish();
    }
