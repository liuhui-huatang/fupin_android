...
public class Leader {
     ...
     * id : 1
     * leader_name : 党建国
     * fcard : 372879878678987876
     * leader_unit : 国务院
     * leader_unit_id : 2
     * leader_duty : 书记
     * leader_phone : 18871584808
     * leader_andscape : 4
     * unit_level : 1
     * help_town_id : 0
     * help_town :
    ...
    private String help_town_id;
    private String help_town;
    private String leader_photo;
    private String leader_assess;
    private String leader_major;
    ...
    public void setLeader_major(String leader_major) {
        this.leader_major = leader_major;
    }
